...
## Возможности 0.5
- Профиль и аватарки
- Друзья (поиск по нику, присоединиться если хостят)
- ЧС (бан-лист) — забаненные не заходят на твои миры
- Кнопка 🐍 в лаунчере — список активных серверов
- Автозапуск Minecraft PE при создании/входе
- Heartbeat хоста (~90 сек без сигнала — мир пропадает)

Оверлей *внутри* Minecraft (модалка хоста, кик в игре) требует нативной доработки — API уже готов.
